...
const GALLERY_DATA = {
  residenza: {
    ...
    photos: [
      { src: 'foto/residenza/residenza-1.jpg', caption: 'Reception & Hall' },
      { src: 'foto/residenza/residenza-2.jpg', caption: 'Bar & Sala colazione' },
      { src: 'foto/residenza/residenza-3.jpg', caption: 'Camera Superior' },
      { src: 'foto/residenza/residenza-4.jpg', caption: 'Camera Deluxe — testa verde' },
      { src: 'foto/residenza/residenza-5.jpg', caption: 'Bagno con piastrelle floreali e specchio LED' },
      { src: 'foto/residenza/residenza-6.jpg', caption: 'Bagno — specchio LED e asciugacapelli a muro' },
    ]
  },
  flat: {
    label: 'Studio Duomo Flat',
    photos: [
      { src: 'foto/flat/flat-1.jpg', caption: 'Soggiorno con scala — piano inferiore' },
      { src: 'foto/flat/flat-2.jpg', caption: 'Scala in legno originale — 2 piani' },
      { src: 'foto/flat/flat-3.jpg', caption: 'Angolo cottura' },
      { src: 'foto/flat/flat-4.jpg', caption: 'Bagno in marmo nero con doccia rain' },
      { src: 'foto/flat/flat-5.jpg', caption: 'Camera matrimoniale con quadro del Vesuvio' },
      { src: 'foto/flat/flat-6.jpg', caption: 'Camera doppia — piano superiore' },
    ]
  },
  maison: {
    label: 'Maison Laezza',
    photos: [
      { src: 'foto/maison/maison-3.jpg', caption: 'Camera matrimoniale', banner: '🏠 Appartamento A' },
      { src: 'foto/maison/maison-2.jpg', caption: 'Cucina attrezzata',   banner: '🏠 Appartamento A' },
      { src: 'foto/maison/maison-1.jpg', caption: 'Bagno con doccia tropical', banner: '🏠 Appartamento A' },
      { src: 'foto/maison/maison-6.jpg', caption: 'Camera matrimoniale', banner: '🏠 Appartamento B' },
      { src: 'foto/maison/maison-5.jpg', caption: 'Cucina con piastrelle vintage', banner: '🏠 Appartamento B' },
      { src: 'foto/maison/maison-4.jpg', caption: 'Bagno in marmo con doccia', banner: '🏠 Appartamento B' },
    ]
  },
  dimora: {
    label: 'Dimora Laezza',
    photos: [
      { src: 'foto/dimora/dimora-1.jpg', caption: 'Camera matrimoniale' },
      { src: 'foto/dimora/dimora-2.jpg', caption: 'Camera doppia' },
      { src: 'foto/dimora/dimora-3.jpg', caption: 'Bagno con doccia' },
      { src: 'foto/dimora/dimora-4.jpg', caption: 'Ingresso' },
      { src: 'foto/dimora/dimora-5.jpg', caption: 'Cucina' },
    ]
  },
};
